...
public class AdminImmersiveTourDetailResponse {
    ...
    private List<ImmersiveSceneResponse> scenes;
    ...
    public List<ImmersiveSceneResponse> getScenes() { return scenes; }
    public void setScenes(List<ImmersiveSceneResponse> scenes) { this.scenes = scenes; }
}
