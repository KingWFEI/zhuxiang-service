...
public interface LeaseTerminationService extends IService<LeaseTerminationApplication> {
    ...
    LeaseTerminationDtos.TerminationCheckResponse checkTermination(String userId, String contractId);

    LeaseTerminationDtos.ApplyResponse apply(String userId, String contractId, LeaseTerminationDtos.ApplyRequest request);

    LeaseTerminationDtos.TerminationDetailResponse getCurrent(String userId, String contractId);
